...
class RiverBasin(HydroDEM, HydroLULC):
    ...
    def plot(self,
        ...
        #         self.mask_vector = basin.copy()             # Drainage area mask
        #         self.rivers = deepcopy(rivers)              # Drainage network
        #         self.main_river = gpd.GeoDataFrame()       # Main channel

        #         # Init HydroDEM constructor
        #         HydroDEM.__init__(self, dem=dem)
        ...
        #         self.geoparams = pd.DataFrame([], index=[self.fid], dtype=object)
        #         self.UnitHydro = None
        ...
        #         if self.geoparams.shape != (1, 0):
        #             param_text = str(self.geoparams).replace(self.fid, '')
        #         else:
        #             param_text = None
        ...
        #         """
        #         self.geoparams.loc[index, :] = value
        #         return self
        ...
        #         self.geoparams = pd.concat([self.geoparams, geoparams], axis=1)
        #         return self

        #     def _processdem(self, **kwargs) -> Type['RiverBasin']:
        #         """
        ...
        #         self.geoparams = pd.concat([self.geoparams, terrain_params], axis=1)
        ...
        #             mriverlen = np.nan
        #             mriverslope = np.nan
        #         self.geoparams['mriverlen'] = mriverlen
        #         self.geoparams['mriverslope'] = mriverslope
        #         return self
        ...
        #             self.geoparams['curvenumber'] = self.cn.mean().item()

        #         # Reorder
        #         self.geoparams = self.geoparams.T.astype(object)
        ...
        #             self.geoparams = nwshed.geoparams
